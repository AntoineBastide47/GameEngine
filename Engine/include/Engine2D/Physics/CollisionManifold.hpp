...
namespace Engine2D::Physics {
  ...
  struct CollisionManifold {
    ...
    CollisionManifold(
      ...
      Engine::Ptr<Rigidbody2D> &rb2, glm::vec2 normal, glm::vec2 contactPoint1, glm::vec2 contactPoint2,
